...
// Source: github.com/dchukmasov/graphql-go-tools/pkg/engine/resolve (interfaces: DataSource,BeforeFetchHook,AfterFetchHook,DataSourceBatch,DataSourceBatchFactory)
...
import (
	...
	fastbuffer "github.com/dchukmasov/graphql-go-tools/pkg/fastbuffer"
)
