//go:generate mockgen --build_flags=--mod=mod -self_package=github.com/dchukmasov/graphql-go-tools/v2/pkg/engine/resolve -destination=resolve_mock_test.go -package=resolve . DataSource,BeforeFetchHook,AfterFetchHook
...
import (
	...
	"github.com/dchukmasov/graphql-go-tools/v2/internal/pkg/xcontext"
